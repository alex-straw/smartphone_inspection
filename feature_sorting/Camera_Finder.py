...
def initialise_phone_objects():
    ...
    phone_1_lit = Phone(1, 66, 105, 0.05, 500000, 1000000, True,    'photographs_new\Phone_1\Camera_Template_1_natural.jpg')

    phone_2_unlit = Phone(2, 0, 25, 0.025, 500000, 1000000, False,  'photographs_new\Phone_2\Camera_Template_2_natural.jpg')
    phone_2_lit = Phone(2, 62, 166, 0.025, 50000, 800000, True,     'photographs_new\Phone_2\Camera_Template_2_natural.jpg')
    ...
    phone_4_lit = Phone(4, 47, 122, 0.03, 80000, 1000000, True,     'photographs_new\Phone_4\Camera_Template_4_natural.jpg')
...
def write_image(image,photo_number,current_phone,tag):
    ...
    image_path = 'camera_identification/' + 'Phone_' + phone_extension + '\Phone_' + phone_extension + lighting_path
    print(image_path)
...
def main():
    ...
    workbook_path = (current_path + '\camera_identification\Camera_Centres.xlsx')
    ...
    template_sorting_results_df.to_excel(current_path + '\camera_identification\Camera_Centres_Results.xlsx', sheet_name='Sheet_name_2')
